...
To use any of the hand tracking OpenXR extensions, ensure the hand tracking Meta XR feature is enabled in export settings.
...
.. image:: img/hand_tracking/hand_mesh.jpg
...
.. image:: img/hand_tracking/hand_mesh_node_tree.jpg

To easily modify the look of the hand mesh, ``OpenXRFbHandTrackingMesh`` has a ``material`` property that users can assign.

.. image:: img/hand_tracking/hand_mesh_material.jpg

Hand Capsules
-------------

.. image:: img/hand_tracking/hand_capsules_mesh.jpg
...
For accessing this data, a number of methods are available in :ref:`OpenXRFbHandTrackingCapsulesExtensionWrapper <class_openxrfbhandtrackingcapsulesextensionwrapper>`.
...
.. image:: img/hand_tracking/hand_capsules_collision_shape.jpg

For more details on how one might use the hand tracking capsules extension, the `Hand Tracking Sample Project <https://github.com/GodotVR/godot_openxr_vendors/tree/master/samples/fb-hand-tracking-sample>`_
implementation can be examined.

Hand Tracking Aim
-----------------

The ``XR_FB_hand_tracking_aim`` extension provides users access to gesture recognition, all of these
gestures are communicated via signals. To enable hand tracking aim, open up **Project Settings**, go to **OpenXR**
settings, and enable ``hand_tracking_aim``, which should be listed below **Extensions**.

.. image:: img/hand_tracking/hand_aim_project_setting.jpg
...
.. image:: img/hand_tracking/hand_aim_tracker_property.jpg
...
.. image:: img/hand_tracking/menu_system_gestures.jpg
